...
import 'package:firebase_notifications_poc/utils/firebase_messaging/firebase_notification_handler.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      //important for handling paging routing
      ...
      home: const MyHomePage(title: 'Firebase Notifications'),
    );
  }
}
